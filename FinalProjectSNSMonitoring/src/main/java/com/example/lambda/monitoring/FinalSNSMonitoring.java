...
public class FinalSNSMonitoring implements RequestHandler<Object, String> {
	...
	public String handleRequest(Object input, Context context) {
	    ...
	    final String AccessKey="AKIAZ6XPGZQXPPFTPUHV";
	    final String SecretKey="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";
	    final String topicArn="arn:aws:sns:ap-northeast-2:684475206702:FinalTopic";
