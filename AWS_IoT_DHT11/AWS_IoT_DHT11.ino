...
void getDeviceStatus(char* payload) {
  ...
  // make payload for the device update topic ($aws/things/FinalExam/shadow/update)
  sprintf(payload,"{\"state\":{\"reported\":{\"temperature\":\"%0.2f\",\"humidity\":\"%0.2f\"}}}",t,h);
}

void sendMessage(char* payload) {
  char TOPIC_NAME[]= "$aws/things/FinalExam/shadow/update";
...
void onMessageReceived(int messageSize) {
  ...
  // 디바이스가 구독한 토픽이 $aws/things/FinalExam/shadow/update/delta 이므로,
  // JSon 문자열 형식은 다음과 같다.
  // {
  //    "version":391,
